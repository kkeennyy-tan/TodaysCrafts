...
namespace Todays_Crafts
{
    public partial class employeecontrol : UserControl
    {
        ...
        private void DisplayData()
        {
            ...
            adapt = new MySqlDataAdapter("select * from employee", con.conDB);
            adapt.Fill(ds);
        ...
        {
            if (textBox2.Text != "" && textBox3.Text != "" && textBox4.Text != "" && textBox5.Text != "" && dateTimePicker1.Text != "" && textBox7.Text != "" && textBox8.Text != "" && textBox9.Text != "" && textBox10.Text != "" && dateTimePicker2.Text != "" && dateTimePicker3.Text != "" && textBox6.Text != "")
            {
                cmd = new MySqlCommand("insert into employee(first_name,last_name,username,password,birthday,address,email,contact_no,gender,date_applied,date_resigned,status) values(@first_name,@last_name,@username,@password,@birthday,@address,@email,@contact_no,@gender,@date_applied,@date_resigned,@status)", con.conDB);
                con.conDB.Open();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                cmd = new MySqlCommand("update employee set first_name=@first_name,last_name=@last_name,username=@username,password=@password,birthday=@birthday,address=@address,email=@email,contact_no=@contact_no,gender=@gender,date_applied=@date_applied,date_resigned=@date_resigned,status =@status where id=@id", con.conDB);
                con.conDB.Open();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                con.conDB.Open();
                cmd = new MySqlCommand("DELETE FROM employee WHERE id = '" + textBox1.Text + "'", con.conDB);
                cmd.ExecuteNonQuery();
        ...
        private void dataGridView1_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            textBox6.Text = dataGridView1.SelectedRows[0].Cells[12].Value.ToString();
        }
